...
/**
 * <p>
 * Percent-encoding, also known as URLNORM encoding, is a mechanism for encoding
 * information in a Uniform Resource Identifier (URI) under certain
 * circumstances. Although it is known as URLNORM encoding it is, in fact, used more
 * generally within the main Uniform Resource Identifier (URI) set, which
 * includes both Uniform Resource Locator (URLNORM) and Uniform Resource Name (URN).
...
public class PercentCodec {
	...
	try {
	    ...
	    throw new IllegalStateException("Unexpected exception during URLNORM decoding", e);
	}
    }
	...
	try {
	    ...
	    throw new IllegalStateException("Unexpected exception during URLNORM encoding", e);
	}
    }
