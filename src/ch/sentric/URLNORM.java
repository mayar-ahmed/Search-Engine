...
public class URLNORM {
     ...
     */
    public URLNORM(final String url) throws MalformedURLException {
     ...
     *             when url could not be parsed
     */
    public URLNORM(final URI uri) throws MalformedURLException {
     ...
     * valid. All fragments will be removed from the original URLNORM.
     * 
     * @return the uri
	...
	final URLNORM other = (URLNORM) obj;
